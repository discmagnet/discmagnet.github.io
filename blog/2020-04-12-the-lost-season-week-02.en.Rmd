...
Trea Turner (96 pts) has a fantastic week and becomes Reid's new top scorer. He is now slashing .344/.420/.590 with 3 HR, 9 RBI, and 3 SB. Eduardo Rodriguez is still his top pitcher, as he is now 2-2 with a 2.67 ERA and 19 K. Mookie Betts and Anthony Rendon are still just hitting .242 and .262, respectively.
...
In addition to strong depth from hitting and pitching, Jonah has two studs leading the way in Juan Soto (110 pts) and Shane Bieber (93 pts). Soto is slashing a tremendous .386/.485/.754 with 4 HR and 16 RBI, and Bieber is 2-1 with a sparkling 0.96 ERA with 28 K. Another notable hitter is Trevor Story (76 pts) who is hitting .313 with 10 RBI with the Rockies. Kirby Yates (55 pts) has started the year with 3 saves, a 1.50 ERA, and an 11:1 K:BB.
